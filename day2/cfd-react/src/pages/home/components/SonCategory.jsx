...
const SonCategory = ({menu=[] }) => {

    return (
        <div className="list__category">
            <div className="listlink">
                {menu.map((tagItem, i) => <h2 key={i}>{tagItem.title}</h2>)}
            </div>
            <Button__buy color="bright" size="large" type="icon-right" icon={<svg width="6" height="10" viewBox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg">
